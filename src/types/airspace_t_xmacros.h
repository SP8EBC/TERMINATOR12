 ...
 */
#define AIRSPACE_CREATE(_radius, _name, _type, ...)													\
 ...
 */
#define AIRSPACE_ARRAY_OF_POINTERS_ENTRY(_radius, _name, _type, ...)				\
		&airspace_##_name,													\
 ...
 */
#define AIRSPACE_ENUM_LIST_ENTRY(_radius, _name, _type, ...)				\
