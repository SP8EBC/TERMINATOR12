...
#define AIRSPACES_HARDCODED_LIST(ENTRY) \
	ENTRY (0, EPBA, AIRSPACE_ATZ, {49.8666667, 18.7666}, {49.8666667, 19.0833}, {49.65, 19.0666}, {49.65, 18.8666}, {49.86, 18.76666})	\
	ENTRY (4000, EPBX, AIRSPACE_TRA, {49.6855667f, 19.0312978f})	\
